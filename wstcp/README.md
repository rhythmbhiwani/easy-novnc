...
- Binaries for the latest commit can be downloaded [here](https://ci.appveyor.com/project/rhythmbhiwani/easy-novnc/build/artifacts).
- You can build your own binaries with go 1.13 or newer using `go get github.com/rhythmbhiwani/easy-novnc/wstcp` or by cloning this repo and running `go build ./wstcp`.
